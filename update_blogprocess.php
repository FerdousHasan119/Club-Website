...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  //echo $id;
      ...
      $sql = "UPDATE `blog` SET `name` = '$uname', `email` = '$uemail', `title` = '$bname', `content` = '$description', `time` = '$time' WHERE `blog`.`id` = $id;";
...
<section id="cta">
        <form id="update_from" class="form" action="update_blogprocess.php" method="POST" novalidate>
          <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12" id=col1>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="bname" placeholder="Blog Name" value="<?php echo $b_title ?>"required>
              </div>
              <div class="form-group">
                <label for="name">Admin Name</label>
                <input type="text" class="form-control" name="uname" placeholder="Admin Name" value="<?php echo $name ?>"required>
              </div><div class="form-group">
                <label for="name">Admin Email</label>
                <input type="text" class="form-control" name="uemail" placeholder="Admin Email" value="<?php echo $email ?>"required>
              </div>
              <div class="form-group">
                <label for="Time">Time</label>
                <input type="text" class="form-control" name="time" placeholder="Time" value="<?php echo $time ?>"required>
              </div>
