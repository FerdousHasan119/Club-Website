<?php
        ...
        if(mysqli_num_rows($run)>0){
            while($row = $run->fetch_assoc()){
                $html = $html. "<tr><td>" . $row["title"] . "</td><td>" . $row["name"] . "</td><td>" . $row["email"] . "</td><td>". $row["time"] . "</td><td>". '<a class="btn btn-lg btn-block btn btn-outline-info" href="view_blogs.php?id=' . $row["id"] .'"><i class="fa-solid fa-arrow-right"></i> View</a>' ."</td></tr>";
