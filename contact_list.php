...
$q =  "SELECT name,position,whtsapp_no,email  FROM contact";
$run = mysqli_query($con, $q);
$html = "";
if(mysqli_num_rows($run)>0){
    while($row = $run->fetch_assoc()){
        $html = $html. "<tr><td>" . $row["name"] . "</td><td>" . $row["position"] . "</td><td>". $row["whtsapp_no"] . "</td><td>". $row["email"] . "</td><td>". '<a class="btn btn-lg btn-block btn btn-success" href="https://wa.me/'. $row["whtsapp_no"] .'"><i class="fa-brands fa-whatsapp"></i> Contact</a>' ."</td></tr>";
...
<body>
  ...
  <div id="cta">
  <h1 class = "cta-heading"><i class="fa-solid fa-person"></i> Conatct List</h1>
  </div>
  ...
  <form class="form" action="#" method="POST">
   ...
   <div class="form-group" id="pad2">
          ...
          <option value="whtsapp_no">WhatsApp No</option>
